// ─────────────────────────────────────────────────────────────
// projects.ts — Your portfolio data lives here.
//
// To add or update a project, just edit this file.
// Each project shows up automatically on the Work page.
// Featured projects (featured: true) appear on the homepage.
//
// Case study pages live at /work/{id} — the link is computed
// automatically from the id field.
// ─────────────────────────────────────────────────────────────

export interface Project {
  id: string           // Unique ID — also becomes the URL: /work/{id}
  title: string        // Project name shown on the card and case study
  client: string       // Company or client
  description: string  // Short summary shown on the card (1–2 sentences)
  tags: string[]       // Discipline tags shown on the card
  year: string         // Year of the project
  featured: boolean    // Set to true to show on the homepage (keep to 3 max)
  imageSrc?: string    // Path to the project image in /public/images/
  imageAlt?: string    // Descriptive alt text for accessibility

  // ── Case study fields ─────────────────────────────────────
  // All pulled from curtiscalhoun.com. Edit freely.
  role?: string        // Your specific role on this project
  overview?: string    // Main body text for the case study
  challenge?: string   // The problem you were brought in to solve
  process?: string     // How you approached it
  outcome?: string     // Results, impact, what shipped
}
...
export const projects: Project[] = [
...

  {
    ...
    client: 'Duke Energy',
    description:
      'Redesigned an internal enterprise tool used by nearly 40,000 employees to manage physical badge access across facilities. Reduced task completion time significantly through simplified workflows and clearer navigation.',
...
This project reinforced the importance of user research in identifying critical pain points and validating design decisions. Collaborating closely with super users allowed us to tailor solutions that genuinely meet their needs.`,
...

  {
    ...
    description:
      'Designed a dark mode version of an enterprise integrations marketplace, synthesizing market research and stakeholder input into a compelling, well-informed design solution.',
...
Visual Design and Presentation: The final design solution was brought to life through meticulous attention to visual design elements, creating a compelling and engaging visual representation that effectively communicated the intended message.`,
...

  {
    ...
    client: 'MobiTV',
    description:
      'Led UX for a next-generation app-based TV experience, spanning mobile, tablet, and living-room form factors. Shipped across multiple carrier partners globally.',
...
The user flow and experience were thoughtfully replicated across various platforms, including Android TV, Fire TV, tvOS, and Roku. This project remains a testament to our commitment to delivering exceptional user experiences and staying at the forefront of the streaming television industry.`,
...

  {
    ...
    client: 'Duke Energy',
    description:
      'Conducted a comprehensive UX audit for an internal GIS application, presenting actionable findings to key stakeholders and demonstrating the measurable value of UX investment.',
...
I engaged in in-depth discussions with users from diverse roles, addressing their primary challenges and exploring their usage patterns within the application. My findings were then presented to the key stakeholders and decision-makers for the product. They were extremely happy with my findings and feedback, and are looking forward to engaging our internal UX team more formally.`,
...

  {
    ...
    client: 'Duke Energy',
    description:
      'Drove the full UX lifecycle (research, ideation, and execution) for a suite of internal productivity tools across the Duke Energy enterprise.',
...
Collaborating with developers, I ensure smooth implementation, resulting in applications that truly resonate with users. Contributing to Duke Energy's mission of reliable, sustainable energy solutions fills me with immense pride, driving me to push the boundaries of exceptional UX design.`,
...

  {
    ...
    description:
      'Envisioned and designed a desktop TV client for macOS, rethinking the conventional 10-foot interface for a 2-foot, cursor-driven context.',
...
Through iterative refinement and user feedback, I ensured the interface exceeded expectations and resonated with potential users. This personal project showcases my passion for UX design and creating remarkable digital interactions.`,
...

  {
    ...
    client: 'Duke Energy',
    description:
      'Revamped an internal tool\'s user flow and hierarchy, applying a "3 click rule" to restructure the sitemap and improve overall navigation and usability.',
...

  {
    ...
    client: 'Personal Project',
    description:
      'Reimagined C Spire TV\'s navigation with a side menu pattern, plus a dedicated kids\' interface with larger icons and a word-free design.',
...
Throughout this process, I embraced iterative design principles, incorporating valuable feedback and user insights to optimize the final outcomes.`,
...

  {
    ...
    client: 'MobiTV',
    description:
      'Led the full mobile UX for a carrier-grade streaming TV app, covering home, guide, browse, and detail screens across iPhone and Android.',
...
The home, guide, browse, and detail screens showcase the seamless user flow and experiences thoughtfully replicated across both iPhone and Android platforms.`,
...

  {
    ...
    client: 'XUMO',
    description:
      'Designed a portrait-orientation live TV experience during a design sprint, inspired by TikTok and Instagram Reels, using pre-fetched streams to minimize buffering.',
...
Taking into account engineering constraints during phase 1 implementation, we made adjustments from the initial concept. Additionally, we recognized contractual obligations from advertisers, particularly in consideration of XUMO's business model reliant on ad revenue. The result is an interface that optimizes the user experience while respecting the practicalities of development and contractual considerations.`,
...

  {
    ...
    client: 'MobiTV',
    description:
      'Designed a system of navigable markers in a TV scrub bar, surfacing highlights and key moments within live streams to enrich the viewing experience.',
...
This collaborative effort allowed us to lay a solid foundation for the concept, making sure all essential aspects were considered. Our concept for navigable markers in the TV scrub bar aims to enrich the viewers' experience, enabling them to discover and engage with highlighted content effortlessly.`,
...

  {
    ...
    client: 'MobiTV',
    description:
      'Early explorations and concept work for MobiTV\'s app-based Pay TV service, pushing the boundaries of what the mobile TV experience could be.',
...
Each concept was thoughtfully and meticulously crafted with an unwavering focus on elevating the television viewing experience. Embracing innovation and user-centric design, we set the stage for a dynamic and immersive journey through the world of app-based television.`,
...

  {
    ...
    client: 'MobiTV',
    description:
      'Connected TV UI explorations for MobiTV\'s streaming Pay TV platform, crafting experiences for a new era of app-based television.',
...
This project stands as a testament to my passion for design and my dedication to creating visionary concepts that make a difference. I cherish the opportunity to have contributed to MobiTV's groundbreaking streaming Pay TV service, and I'm thrilled to have been a part of reshaping the future of television.`,
...

  {
    ...
    client: 'ipsh! (Omnicom)',
    description:
      'Eight years of freelance design and development for an Omnicom-owned mobile marketing agency, spanning branded websites, Flash apps, and interactive campaigns for household names.',
...
This enriching experience nurtured my passion for innovation and cultivated my expertise in crafting captivating user experiences across diverse platforms.`,
...

  {
    ...
    description:
      "Designed and developed a real-time text-to-screen fan activation app that ran live on the Cowboys' stadium HD screens during games.",
...
To facilitate this dynamic interaction, I utilized APIs to transmit the incoming texts and images to the application in an instant, ensuring smooth and swift display on the HD screens. This project showcases my ability to merge creativity and technical prowess to create unforgettable fan experiences.`,
...

  {
    ...
    description:
      'Served as principal product designer on MobiTV\'s next-generation mobile TV platform, shipped with AT&T, Verizon, T-Mobile, and US Cellular.',
...
'NG' was a testament to MobiTV's commitment to pushing the boundaries of mobile entertainment and delivering exceptional user experiences.`,
...

  {
    ...
    client: 'Doritos / ipsh!',
    description:
      'Designed and developed a Flash-based campaign landing page for the Doritos Flavor Shots product launch, featuring immersive graphics, animations, and interactive engagement.',
...
// Helper: returns only the featured projects for the homepage
